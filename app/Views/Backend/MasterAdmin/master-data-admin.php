            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <h3>Master Data Admin
                        <a href="<?= base_url('admin/input-data-admin');?>"><button type="button"
                                class="btn btn-sm btn-primary pull-right">Input Data Admin</button></a>
                    </h3>
                    <hr />
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-sortable="true">
                                    ...
                                    ?>
                                    <a href="<?= base_url('admin/edit-data-admin/'.sha1($data['id_admin']));?>"><button
                                            type="button" class="btn btn-sm btn-success">Edit</button></a>
                                    <a href="#" onclick="doDelete('<?= sha1($data['id_admin']);?>')"><button
                                            type="button" class="btn btn-sm btn-danger">Hapus</button></a>
                                    <?php } else echo "#"; ?>
                                </td>
                            </tr>
                            <?php } ?>
